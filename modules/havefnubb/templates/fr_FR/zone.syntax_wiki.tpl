...
<ul>
    <li class="source"><strong>bloc code source</strong> : chaque ligne doit débuter par un espace (les balises wiki ne sont pas interprétées)</li>
    <li class="list"><strong>Liste</strong> : chaque ligne doit débuter par une ou plusieurs * ou - (liste simple) ou # (liste numérotée)</li>
...
<ul>
    <li class="para"><strong>Paragraphe</strong> : 2 sauts de lignes</li>
    <li class="def"><strong>Définitions</strong> : ;terme : définition + saut de ligne (le : doit être encadré par des espaces)</li>
</ul>
...
<ul>
    ...
    <li class="quoting"><strong>citation</strong> : ^^phrase|langue|lien source^^</li>
    <li class="ref"><strong>reférence (cite)</strong> : {literal}{{reference}}{/literal}</li>
    <li class="acronym"><strong>acronym</strong> : ??acronyme|signification??</li>
</ul>
</div>