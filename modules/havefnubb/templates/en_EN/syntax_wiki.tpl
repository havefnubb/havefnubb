...
<ul>
    <li><strong>source code bloc</strong>: each line should begin by a space</li>
    <li><strong>List</strong>: each line should begin by one or several *, - or #</li>
...
<ul>
    <li><strong>Paragraphe</strong>: 2 break line</li>
    <li><strong>Definitions</strong>: ;term : definition + a break line</li>
</ul>
...
<ul>
    ...
    <li><strong>cite</strong> : ^^sentence|lang|link of source^^</li>
    <li><strong>reference (cite)</strong> : {{reference}}</li>
    <li><strong>acronym</strong> : ??acronym|explanation??</li>
</ul>
</div>