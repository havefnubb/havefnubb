{ifuserconnected}
    <ul>
        <li>{@havefnubb~member.status.welcome@} <a href="{jurl 'jcommunity~account:prepareedit', array('user'=>$login)}">{$login}.</a>{hook 'hfbJcommunityStatusConnected',array('login'=>$login)}</li>
    </ul>
    <ul>
