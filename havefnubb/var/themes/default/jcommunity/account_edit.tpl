	...
	<div id="container" class="formbg">
        ...
        <div id="member-messenger">
            <fieldset>
                ...
                <div class="two-cols">
                    <p class="col">
                        <label id="xfire"><strong>{ctrl_label 'member_xfire'}</strong></label><br />{ctrl_control 'member_xfire'}
                    </p>                   
                    <p class="col">
                        <label id="icq"><strong>{ctrl_label 'member_icq'}</strong></label><br />{ctrl_control 'member_icq'}
                    </p>                   
                </div>
                 <div class="two-cols">
                    <p class="col">
						<label id="yim"><strong>{ctrl_label 'member_yim'}</strong></label><br />{ctrl_control 'member_yim'}
                    </p>                   
                    <p class="col">
                        <label id="msn"><strong>{ctrl_label 'member_hotmail'}</strong></label><br />{ctrl_control 'member_hotmail'}
                    </p>                   
                </div>
                 <div class="two-cols">
                    <p class="col">
						<label id="aim"><strong>{ctrl_label 'member_aol'}</strong></label><br />{ctrl_control 'member_aol'}
                    </p>                   
                    <p class="col">
						<label id="gtalk"><strong>{ctrl_label 'member_gtalk'}</strong></label><br />{ctrl_control 'member_gtalk'}						
                    </p>                   
                </div>                    
                 <div class="two-cols">
                    <p class="col">
						<label id="jabber"><strong>{ctrl_label 'member_jabber'}</strong></label><br />{ctrl_control 'member_jabber'}							
                    </p>                   
                    <p class="col">                        
                    </p>                   
                </div>                    
        ...
        <div id="member-hardware">
            <fieldset>
                ...
                <div class="two-cols">
                    <p class="col">                 
                        <label id="connect"><strong>{ctrl_label 'member_connection'}</strong></label><br />{ctrl_control 'member_connection'}
                    </p>
                    <p class="col">                                
                        <label id="os"><strong>{ctrl_label 'member_os'}</strong></label>      <br />{ctrl_control 'member_os'}
                    </p>
                </div>                
                <div class="two-cols">
                    <p class="col">                 
                        <label id="processor"><strong>{ctrl_label 'member_proc'}</strong></label>    <br />{ctrl_control 'member_proc'}
                    </p>
                    <p class="col">                                
                        <label id="motherboard"><strong>{ctrl_label 'member_mb'}</strong></label>      <br />{ctrl_control 'member_mb'}
                    </p>
                </div>                
                <div class="two-cols">
                    <p class="col">                 
                        <label id="card"><strong>{ctrl_label 'member_card'}</strong></label>    <br />{ctrl_control 'member_card'}
                    </p>
                    <p class="col">                                
                        <label id="ram"><strong>{ctrl_label 'member_ram'}</strong></label>     <br />{ctrl_control 'member_ram'}
                    </p>
                </div>            
                <div class="two-cols">
                    <p class="col">                 
                        <label id="display"><strong>{ctrl_label 'member_display'}</strong></label> <br />{ctrl_control 'member_display'}
                    </p>
                    <p class="col">                                
                        <label id="screen"><strong>{ctrl_label 'member_screen'}</strong></label>  <br />{ctrl_control 'member_screen'}
                    </p>
                </div>            
                <div class="two-cols">
                    <p class="col">                 
                        <label id="mouse"><strong>{ctrl_label 'member_mouse'}</strong></label>   <br />{ctrl_control 'member_mouse'}
                    </p>
                    <p class="col">                                
                        <label id="keyboard"><strong>{ctrl_label 'member_keyb'}</strong></label>    <br />{ctrl_control 'member_keyb'}
                    </p>
                </div>
            </fieldset>
        </div>
