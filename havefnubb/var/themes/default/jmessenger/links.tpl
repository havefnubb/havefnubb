...
<div id="breadcrumbtop" class="headbox">
    <h3 id="user"><a href="{jurl 'jcommunity~account:edit',array('user'=>$login)}">{@havefnubb~member.edit.account.header@}</a> - <span class="user-private-message">{@havefnubb~member.internal.messenger@}</span>
