...
{foreach $forumChilds as $forum}
    <li><a href="{jurl 'havefnubb~posts:lists',array('id_forum'=>$forum->id_forum)}" title="{$forum->forum_name|eschtml}">{$forum->forum_name|eschtml}</a></li>
{/foreach}
</ul>
{else}
<div class="subforum">
...
{foreach $forumChilds as $forum}
    <tr>
        <td class="line colleft"></td>
        <td class="line colmain linkincell"><h4><a href="{jurl 'havefnubb~posts:lists',array('id_forum'=>$forum->id_forum)}" title="{$forum->forum_name|eschtml}">{$forum->forum_name|eschtml}</a></h4>{$forum->forum_desc|eschtml}</td>
