...
{@havefnubb~main.last.post@} : <a href="{jurl 'havefnubb~posts:view',array('id_post'=>$lastPost->parent_id,'parent_id'=>$lastPost->parent_id,'ptitle'=>$lastPost->subject,'ftitle'=>$forum->forum_name)}" title="{@havefnubb~main.goto.this.message@}">{$lastPost->subject|eschtml}</a><br/>
