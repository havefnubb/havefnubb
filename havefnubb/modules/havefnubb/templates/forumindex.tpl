...
{foreach $forums as $forum}
    <tr>
        <td class="colleft"></td>
        <td class="colmain linkincell"><h4><a href="{jurl 'posts:lists',array('id'=>$forum->id_forum)}" title="{$forum->forum_name|eschtml}">{$forum->forum_name|eschtml}</a></h4>{$forum->forum_desc|eschtml}</td>
