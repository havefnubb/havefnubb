...
INSERT INTO `hf_forum` (`id_forum`, `forum_name`, `id_cat`, `forum_desc`, `forum_order`, `parent_id`, `child_level`,`forum_type`,`forum_url`) VALUES
...
CREATE TABLE IF NOT EXISTS `hf_poll_answer` (
...
CREATE TABLE IF NOT EXISTS `hf_poll_users` (
  `id_poll` int(11) NOT NULL,
  `id_answer` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  PRIMARY KEY (`id_poll`,`id_answer`,`id_user`)
)DEFAULT CHARSET=utf8;