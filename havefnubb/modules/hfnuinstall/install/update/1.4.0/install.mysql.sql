...
INSERT INTO hf_threads (id_thread,id_forum,id_user,status,nb_viewed,date_created) SELECT parent_id,id_forum,id_user,status,viewed,date_created FROM hf_posts WHERE parent_id=id_post;
