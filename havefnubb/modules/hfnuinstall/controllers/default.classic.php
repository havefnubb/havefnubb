...
//							throw new jException('hfnuinstall~install.installdb.directory.not.writable',JELIX_APP_TEMP_PATH );
	...
	/**
	 * Method to update to 1.3.3
	 */
	function update_to_1_3_3() {
		global $gJConfig;
	...
	/**
	 * Method to update to 1.3.6
	 */
	function update_to_1_3_6() {
		global $gJConfig;
	...
	/**
	 * Method to update to 1.4.0
	 */
	function update_to_1_4_0() {
		global $gJConfig;
	...
	private static function _update_to_1_3_1() {
		$mainConfig = new jIniFileModifier(JELIX_APP_CONFIG_PATH . 'defaultconfig.ini.php');
		$mainConfig->setValue('version','1.3.1','havefnubb');
		$mainConfig->save();
		jFile::removeDir(JELIX_APP_TEMP_PATH, false);
	}

	private static function _update_to_1_3_2() {
		$mainConfig = new jIniFileModifier(JELIX_APP_CONFIG_PATH . 'defaultconfig.ini.php');
		$mainConfig->setValue('version','1.3.2','havefnubb');
		$mainConfig->save();
		jFile::removeDir(JELIX_APP_TEMP_PATH, false);
	}

	private static function _update_to_1_3_3() {
		$mainConfig = new jIniFileModifier(JELIX_APP_CONFIG_PATH . 'defaultconfig.ini.php');
		$mainConfig->setValue('version','1.3.3','havefnubb');
		$mainConfig->save();
		jFile::removeDir(JELIX_APP_TEMP_PATH, false);
	}
	...
	private static function _update_to_1_3_6() {
		global $gJConfig;
		//default fake prefix uses in the filename if no prefix table are filled
		$tablePrefix = 'null_';
		...
		$file = dirname(__FILE__).'/../install/update/1.3.6/install.'.$dbProfile[$dbProfile['default']]['driver'].'.sql';
		if ($dbProfile[$dbProfile['default']]['table_prefix'] != '' ) {
			$tablePrefix = $dbProfile[$dbProfile['default']]['table_prefix'] ;
		}
		$fileDest = JELIX_APP_TEMP_PATH.$tablePrefix.'install-1.3.6.'.$dbProfile[$dbProfile['default']]['driver'].'.sql';
		$sources = file($file);
		$newSource = '';
		...
		fwrite($fh,$newSource);
		fclose($fh);
		$file = JELIX_APP_TEMP_PATH.$tablePrefix.'install-1.3.6.'.$dbProfile[$dbProfile['default']]['driver'].'.sql';
	...
	private static function _update_to_1_4_0() {
		global $gJConfig;
		//default fake prefix uses in the filename if no prefix table are filled
		$tablePrefix = 'null_';
		...
		$file = dirname(__FILE__).'/../install/update/1.4.0/install.'.$dbProfile[$dbProfile['default']]['driver'].'.sql';
		if ($dbProfile[$dbProfile['default']]['table_prefix'] != '' ) {
			$tablePrefix = $dbProfile[$dbProfile['default']]['table_prefix'] ;
		}
		$fileDest = JELIX_APP_TEMP_PATH.$tablePrefix.'install-1.4.0.'.$dbProfile[$dbProfile['default']]['driver'].'.sql';
		$sources = file($file);
		$newSource = '';
		...
		fwrite($fh,$newSource);
		fclose($fh);
		$file = JELIX_APP_TEMP_PATH.$tablePrefix.'install-1.4.0.'.$dbProfile[$dbProfile['default']]['driver'].'.sql';

		$tools->execSQLScript($file);
		@unlink($file);

		$mainConfig = new jIniFileModifier(JELIX_APP_CONFIG_PATH . 'defaultconfig.ini.php');
		$mainConfig->setValue('version','1.4.0','havefnubb');
		$mainConfig->save();
		jFile::removeDir(JELIX_APP_TEMP_PATH, false);
